"""autogenerated by genmsg_py from TactileButton.msg. Do not edit."""
import roslib.message
import struct


class TactileButton(roslib.message.Message):
  _md5sum = "5cb8da9b806dccba1fbc0fdc508a1f4e"
  _type = "nao_sensors/TactileButton"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TactileButton, self).__init__(*args, **kwds)
